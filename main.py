...
import nltk
#nltk.download()
if 'C:/Users/aasensio/AppData/Roaming/nltk_data' not in nltk.data.path:
    nltk.data.path.append('C:/Users/aasensio/AppData/Roaming/nltk_data')
